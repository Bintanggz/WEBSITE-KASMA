    ...
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="pb-4 border-b border-zinc-200">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                <div>
                    <h2 class="text-xl font-bold text-zinc-900 tracking-tight">Pengaturan Akun &amp; Profil</h2>
                ...
                <div class="flex items-center gap-2">
                    <span class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold {{ $user->isBendahara() ? 'bg-amber-50 text-amber-900 border border-amber-200' : 'bg-emerald-50 text-emerald-900 border border-emerald-200' }}">
        ...
        @if(session('success'))
            <div class="p-3.5 rounded-xl bg-emerald-50 border border-emerald-200 text-emerald-900 text-xs flex items-center justify-between">
                <div class="flex items-center gap-2">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="bg-white rounded-xl border border-zinc-200 shadow-xs p-5 sm:p-6 space-y-5">
                ...
                <div class="space-y-3.5 text-xs">
                    ...
                    @if($user->nim)
                    <div>
                        <span class="text-[11px] font-semibold text-zinc-400 uppercase tracking-wider block mb-1">Nomor Induk Mahasiswa (NIM)</span>
                        <div class="p-2.5 rounded-lg bg-zinc-50 border border-zinc-200 font-mono text-zinc-800">
                            {{ $user->nim }}
                        </div>
                    </div>
                    @endif
                    ...
                    <div>
                        <span class="text-[11px] font-semibold text-zinc-400 uppercase tracking-wider block mb-1">Alamat Email</span>
                        <div class="p-2.5 rounded-lg bg-zinc-50 border border-zinc-200 font-mono text-zinc-800">
                            {{ $user->email }}
                        </div>
                    </div>
            ...
            <div class="bg-white rounded-xl border border-zinc-200 shadow-xs p-5 sm:p-6 space-y-5">
                <div class="border-b border-zinc-200 pb-3">
                    <h3 class="text-sm font-bold text-zinc-900">Keamanan &amp; Kata Sandi</h3>
                    <p class="text-xs text-zinc-500 mt-0.5">Perbarui kata sandi Anda secara berkala untuk menjaga keamanan akun</p>
                </div>
                ...
                <form method="POST" action="{{ route('profile.password') }}" class="space-y-4">
                    ...
                    <div x-data="{ showCurrent: false }">
                        <label for="current_password" class="text-[11px] font-semibold text-zinc-700 uppercase tracking-wider block mb-1">
                            Kata Sandi Saat Ini
                        </label>
                        <div class="relative">
                            <input id="current_password"
                                   ...
                                   class="w-full px-3.5 py-2 pr-10 text-xs rounded-lg border border-zinc-300 bg-white text-zinc-900 placeholder-zinc-400 focus:outline-none focus:border-zinc-900 focus:ring-1 focus:ring-zinc-900 transition">
                            <button type="button"
                    ...
                    <div x-data="{ showNew: false }">
                        <label for="password" class="text-[11px] font-semibold text-zinc-700 uppercase tracking-wider block mb-1">
                            Kata Sandi Baru
                        </label>
                        <div class="relative">
                            <input id="password"
                    ...
                    <div x-data="{ showConfirm: false }">
                        <label for="password_confirmation" class="text-[11px] font-semibold text-zinc-700 uppercase tracking-wider block mb-1">
                    ...
                    <div class="pt-2">
                        <button type="submit"
                                class="w-full py-2.5 px-4 text-xs font-semibold rounded-lg bg-zinc-900 hover:bg-zinc-800 text-white transition shadow-xs cursor-pointer">
                            Perbarui Kata Sandi
                        </button>
                    </div>
                </form>
