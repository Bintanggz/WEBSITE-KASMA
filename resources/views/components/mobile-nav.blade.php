...
<div>
    ...
    <div x-show="mobileMenuOpen" 
        ...
        <div>
            ...
            <div class="p-4 space-y-1">
                @if($role === 'mahasiswa')
                <!-- Mahasiswa Menu -->
                <a href="/mahasiswa/dashboard" @click="mobileMenuOpen = false" class="flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-lg {{ request()->routeIs('mahasiswa.dashboard') ? 'bg-stone-100 text-stone-900 font-semibold' : 'text-stone-600 hover:bg-stone-50' }}">
                    <svg class="w-4 h-4 {{ request()->routeIs('mahasiswa.dashboard') ? 'text-stone-700' : 'text-stone-400' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                    </svg>
                    <span>Dashboard</span>
                </a>
                <a href="{{ route('mahasiswa.iuran.index') }}" @click="mobileMenuOpen = false" class="flex items-center justify-between px-3 py-2 text-sm font-medium rounded-lg {{ request()->routeIs('mahasiswa.iuran.*') ? 'bg-stone-100 text-stone-900 font-semibold' : 'text-stone-600 hover:bg-stone-50' }}">
                ...
                <a href="{{ route('mahasiswa.riwayat.index') }}" @click="mobileMenuOpen = false" class="flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-lg {{ request()->routeIs('mahasiswa.riwayat.*') ? 'bg-stone-100 text-stone-900 font-semibold' : 'text-stone-600 hover:bg-stone-50' }}">
                ...
                @else
                <!-- Bendahara Menu -->
                <a href="/bendahara/dashboard" @click="mobileMenuOpen = false" class="flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-lg {{ request()->routeIs('bendahara.dashboard') ? 'bg-stone-100 text-stone-900 font-semibold' : 'text-stone-600 hover:bg-stone-50' }}">
                ...
                <a href="{{ route('bendahara.iuran.index') }}" @click="mobileMenuOpen = false" class="flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-lg {{ request()->routeIs('bendahara.iuran.*') ? 'bg-stone-100 text-stone-900 font-semibold' : 'text-stone-600 hover:bg-stone-50' }}">
                ...
                <a href="{{ route('bendahara.verifikasi.index') }}" @click="mobileMenuOpen = false" class="flex items-center justify-between px-3 py-2 text-sm font-medium rounded-lg {{ request()->routeIs('bendahara.verifikasi.*') ? 'bg-stone-100 text-stone-900 font-semibold' : 'text-stone-600 hover:bg-stone-50' }}">
                    <div class="flex items-center gap-3">
                ...
                <a href="{{ route('bendahara.mahasiswa.index') }}" @click="mobileMenuOpen = false" class="flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-lg {{ request()->routeIs('bendahara.mahasiswa.*') ? 'bg-stone-100 text-stone-900 font-semibold' : 'text-stone-600 hover:bg-stone-50' }}">
    ...
    <nav class="md:hidden fixed bottom-0 inset-x-0 z-30 bg-white/95 border-t border-stone-200 py-2 px-2 sm:px-4 flex justify-around items-center">
        ...
        <a href="{{ route('mahasiswa.iuran.index') }}" class="flex flex-col items-center gap-1 {{ request()->routeIs('mahasiswa.iuran.*') ? 'text-stone-900 font-semibold' : 'text-stone-500 hover:text-stone-900' }}">
            <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
            </svg>
            <span class="text-[10px] font-medium leading-none">Iuran</span>
        </a>
        <a href="{{ route('mahasiswa.riwayat.index') }}" class="flex flex-col items-center gap-1 {{ request()->routeIs('mahasiswa.riwayat.*') ? 'text-stone-900 font-semibold' : 'text-stone-500 hover:text-stone-900' }}">
            <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
            </svg>
        ...
        @else
        <a href="/bendahara/dashboard" class="flex flex-col items-center gap-1 {{ request()->routeIs('bendahara.dashboard') ? 'text-stone-900 font-semibold' : 'text-stone-500 hover:text-stone-900' }}">
            <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
            </svg>
            <span class="text-[10px] font-medium leading-none">Dashboard</span>
        </a>
        <a href="{{ route('bendahara.iuran.index') }}" class="flex flex-col items-center gap-1 {{ request()->routeIs('bendahara.iuran.*') ? 'text-stone-900 font-semibold' : 'text-stone-500 hover:text-stone-900' }}">
            <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
            </svg>
            <span class="text-[10px] font-medium leading-none">Iuran</span>
        </a>
        <a href="{{ route('bendahara.verifikasi.index') }}" class="flex flex-col items-center gap-1 {{ request()->routeIs('bendahara.verifikasi.*') ? 'text-stone-900 font-semibold' : 'text-stone-500 hover:text-stone-900' }} relative">
            <svg class="w-5 h-5 {{ request()->routeIs('bendahara.verifikasi.*') ? 'text-stone-900' : 'text-stone-400' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
