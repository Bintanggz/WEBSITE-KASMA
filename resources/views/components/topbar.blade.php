    ...
    <div class="px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-3">
            <button type="button" 
                    ...
                    class="md:hidden p-2 -ml-2 rounded-lg text-stone-600 hover:text-stone-900 hover:bg-stone-100 transition"
        ...
        <div class="flex items-center gap-2.5 sm:gap-3">
            ...
            <button type="button" 
                    ...
                    class="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold rounded-lg text-white bg-emerald-800 hover:bg-emerald-900 transition shadow-2xs">
            ...
            @else
            <!-- Bendahara CTA: Record Transaction -->
            <button type="button" 
            ...
            <form method="POST" action="{{ route('logout') }}" class="inline">
                @csrf
                <button type="submit" 
                        class="p-2 text-stone-400 hover:text-rose-600 hover:bg-stone-100 rounded-lg transition"
                        title="Keluar">
                    <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
